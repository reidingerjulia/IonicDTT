...
var $author$project$Test$GotSeed = function (a) {
	return {$: 'GotSeed', a: a};
};
var $author$project$Test$GotTime = function (a) {
	return {$: 'GotTime', a: a};
};
var $author$project$Test$Waiting = function (a) {
	return {$: 'Waiting', a: a};
};
var $author$project$Test$WaitingSpecific = function (a) {
	return {$: 'WaitingSpecific', a: a};
};
...
var $author$project$Test$init = function (_v0) {
	return _Utils_Tuple2(
		$author$project$Test$Waiting(
			{currentTime: $elm$core$Maybe$Nothing, initialSeed: $elm$core$Maybe$Nothing, user: $elm$core$Maybe$Nothing}),
		$elm$core$Platform$Cmd$batch(
			_List_fromArray(
				[
					A2(
					$elm$random$Random$generate,
					A2($elm$core$Basics$composeR, $author$project$Test$GotSeed, $author$project$Test$WaitingSpecific),
					$elm$random$Random$independentSeed),
					A2(
					$elm$core$Task$perform,
					A2($elm$core$Basics$composeR, $author$project$Test$GotTime, $author$project$Test$WaitingSpecific),
					$elm$time$Time$now)
				])));
};
var $author$project$Test$ApiSpecific = function (a) {
	return {$: 'ApiSpecific', a: a};
};
var $author$project$Api$GotTime = function (a) {
	return {$: 'GotTime', a: a};
};
var $author$project$Test$RunningSpecific = function (a) {
	return {$: 'RunningSpecific', a: a};
};
	...
	if (model.$ === 'Running') {
		return A2(
			...
			A2(
				...
				$author$project$Api$GotTime,
				A2($elm$core$Basics$composeR, $author$project$Test$ApiSpecific, $author$project$Test$RunningSpecific)));
	} else {
		return $elm$core$Platform$Sub$none;
	}
};
var $author$project$Test$FromApi = function (a) {
	return {$: 'FromApi', a: a};
};
var $author$project$Test$InternalError = function (a) {
	return {$: 'InternalError', a: a};
};
var $author$project$Test$ParsingError = function (a) {
	return {$: 'ParsingError', a: a};
};
var $author$project$Test$Running = function (a) {
	return {$: 'Running', a: a};
};
var $author$project$Test$WrongFormat = function (a) {
	return {$: 'WrongFormat', a: a};
};
var $author$project$Test$WrongInput = function (a) {
	return {$: 'WrongInput', a: a};
};
...
var $author$project$Test$initModel = function (apiModel) {
	return {
		apiModel: apiModel,
		budget: {spendings: _List_Nil, totalCent: 0},
		error: $elm$core$Maybe$Nothing,
		inputAmount: '',
		inputContent: '',
		inputId: '',
		secretsList: _List_Nil,
		todoList: _List_Nil
	};
};
var $author$project$Test$validateWaitingModel = function (waitingModel) {
	var user = waitingModel.user;
	var currentTime = waitingModel.currentTime;
	var initialSeed = waitingModel.initialSeed;
	var _v0 = _Utils_Tuple3(user, currentTime, initialSeed);
	if (((_v0.a.$ === 'Just') && (_v0.b.$ === 'Just')) && (_v0.c.$ === 'Just')) {
		var u = _v0.a.a;
		var c = _v0.b.a;
		var i = _v0.c.a;
		var _v1 = $author$project$Api$init(
			{currentTime: c, initialSeed: i, user: u});
		var apiModel = _v1.a;
		var cmd = _v1.b;
		return _Utils_Tuple2(
			$author$project$Test$Running(
				$author$project$Test$initModel(apiModel)),
			A2(
				$elm$core$Platform$Cmd$map,
				A2($elm$core$Basics$composeR, $author$project$Test$ApiSpecific, $author$project$Test$RunningSpecific),
				cmd));
		...
		return _Utils_Tuple2(
			$author$project$Test$Waiting(waitingModel),
			$elm$core$Platform$Cmd$none);
	}
};
var $author$project$Test$update = F2(
	function (msg, model) {
		var defaultCase = _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
		var _v0 = _Utils_Tuple2(msg, model);
		_v0$2:
		while (true) {
			if (_v0.a.$ === 'RunningSpecific') {
				if (_v0.b.$ === 'Running') {
					var runningMsg = _v0.a.a;
					var runningModel = _v0.b.a;
					switch (runningMsg.$) {
						case 'ApiSpecific':
							var apiMsg = runningMsg.a;
							return A3(
								$elm$core$Tuple$mapBoth,
								function (m) {
									return $author$project$Test$Running(
										_Utils_update(
											runningModel,
											{apiModel: m}));
								},
								$elm$core$Platform$Cmd$map($author$project$Test$RunningSpecific),
								A4(
									$author$project$Api$update,
									A2(
										$elm$core$Basics$composeR,
										$elm$core$Task$succeed,
										$elm$core$Task$perform($author$project$Test$FromApi)),
									$author$project$Test$ApiSpecific,
									apiMsg,
									runningModel.apiModel));
						case 'FromApi':
							var value = runningMsg.a;
							var _v2 = A2($miniBill$elm_codec$Codec$decodeValue, $author$project$DTT$Data$OutputForm$codec, value);
							if (_v2.$ === 'Ok') {
								var outputForm = _v2.a;
								var error = outputForm.error;
								var todo = outputForm.todo;
								var secrets = outputForm.secrets;
								var budget = outputForm.budget;
								var _v3 = _Utils_Tuple2(
									_Utils_Tuple2(error, todo),
									_Utils_Tuple2(secrets, budget));
								_v3$4:
								while (true) {
									if (_v3.a.a.$ === 'Just') {
										if (((_v3.a.b.$ === 'Nothing') && (_v3.b.a.$ === 'Nothing')) && (_v3.b.b.$ === 'Nothing')) {
											var _v4 = _v3.a;
											var err = _v4.a.a;
											var _v5 = _v4.b;
											var _v6 = _v3.b;
													...
													_Utils_update(
														runningModel,
														{
															error: $elm$core$Maybe$Just(
																$author$project$Test$InternalError(err))
														})),
												$elm$core$Platform$Cmd$none);
										} else {
											break _v3$4;
										...
										if (_v3.a.b.$ === 'Just') {
											if ((_v3.b.a.$ === 'Nothing') && (_v3.b.b.$ === 'Nothing')) {
												var _v9 = _v3.a;
												var _v10 = _v9.a;
												var todoList = _v9.b.a;
												var _v11 = _v3.b;
												var _v12 = _v11.a;
												var _v13 = _v11.b;
												return _Utils_Tuple2(
													$author$project$Test$Running(
														_Utils_update(
															runningModel,
															{error: $elm$core$Maybe$Nothing, todoList: todoList})),
													$elm$core$Platform$Cmd$none);
											} else {
												break _v3$4;
											}
											...
											if (_v3.b.a.$ === 'Just') {
												if (_v3.b.b.$ === 'Nothing') {
													...
													var _v16 = _v14.b;
													var _v17 = _v3.b;
													var secretsList = _v17.a.a;
													var _v18 = _v17.b;
													return _Utils_Tuple2(
														$author$project$Test$Running(
															_Utils_update(
																runningModel,
																{error: $elm$core$Maybe$Nothing, secretsList: secretsList})),
														$elm$core$Platform$Cmd$none);
												} else {
													break _v3$4;
												}
												...
												if (_v3.b.b.$ === 'Just') {
													...
													return _Utils_Tuple2(
														$author$project$Test$Running(
															_Utils_update(
																runningModel,
																{budget: b, error: $elm$core$Maybe$Nothing})),
														$elm$core$Platform$Cmd$none);
												} else {
													break _v3$4;
												}
								...
								return _Utils_Tuple2(
									$author$project$Test$Running(
										_Utils_update(
											...
											{
												error: $elm$core$Maybe$Just(
													$author$project$Test$WrongFormat(outputForm))
											})),
									$elm$core$Platform$Cmd$none);
							} else {
								return _Utils_Tuple2(
									$author$project$Test$Running(
										_Utils_update(
											...
											{
												error: $elm$core$Maybe$Just(
													$author$project$Test$ParsingError(value))
											})),
									$elm$core$Platform$Cmd$none);
							}
						case 'ChangedId':
							var string = runningMsg.a;
							return _Utils_Tuple2(
								$author$project$Test$Running(
									_Utils_update(
										runningModel,
						...
						case 'ChangedAmount':
							...
							return _Utils_Tuple2(
								...
								$elm$core$Platform$Cmd$none);
						default:
							var page = runningMsg.a.page;
							var action = runningMsg.a.action;
							var inputWithIdAndContentAndAmount = {
								action: action,
								amount: $elm$core$String$toInt(runningModel.inputAmount),
								content: $elm$core$Maybe$Just(runningModel.inputContent),
								id: $elm$core$Maybe$Just(runningModel.inputId),
								page: page
							};
							var inputWithIdAndContent = {
								action: action,
								amount: $elm$core$Maybe$Nothing,
								content: $elm$core$Maybe$Just(runningModel.inputContent),
								id: $elm$core$Maybe$Just(runningModel.inputId),
								page: page
							};
							...
							var inputNone = {action: action, amount: $elm$core$Maybe$Nothing, content: $elm$core$Maybe$Nothing, id: $elm$core$Maybe$Nothing, page: page};
							var maybeInput = function () {
								var _v25 = _Utils_Tuple3(
									...
									_Utils_Tuple3(
										...
										!_Utils_eq(
											$elm$core$Maybe$Nothing,
											$elm$core$String$toInt(runningModel.inputAmount))));
								_v25$11:
								while (true) {
									if (!_v25.c.a) {
										if (!_v25.c.b) {
											if ((_v25.b === 'sync') && (!_v25.c.c)) {
												switch (_v25.a) {
													case 'todo':
														var _v26 = _v25.c;
														return $elm$core$Maybe$Just(inputNone);
													case 'secrets':
														var _v30 = _v25.c;
														return $elm$core$Maybe$Just(inputNone);
													case 'budget':
											...
											if (!_v25.c.c) {
												switch (_v25.a) {
													case 'todo':
														if (_v25.b === 'insert') {
															var _v27 = _v25.c;
															return $elm$core$Maybe$Just(inputWithContent);
														} else {
															break _v25$11;
														}
													case 'secrets':
												...
												if ((_v25.a === 'budget') && (_v25.b === 'insert')) {
													var _v34 = _v25.c;
													return $elm$core$Maybe$Just(inputWithContentAndAmount);
												} else {
													break _v25$11;
												}
											}
										...
										if (!_v25.c.b) {
											if ((_v25.b === 'delete') && (!_v25.c.c)) {
												switch (_v25.a) {
													case 'todo':
														var _v28 = _v25.c;
														return $elm$core$Maybe$Just(inputWithId);
													case 'budget':
														var _v35 = _v25.c;
														return $elm$core$Maybe$Just(inputWithId);
													default:
											...
											if (_v25.b === 'update') {
												if (!_v25.c.c) {
													if (_v25.a === 'todo') {
														var _v29 = _v25.c;
														return $elm$core$Maybe$Just(inputWithIdAndContent);
													} else {
														break _v25$11;
													}
												} else {
													if (_v25.a === 'budget') {
														var _v36 = _v25.c;
														return $elm$core$Maybe$Just(inputWithIdAndContentAndAmount);
													} else {
														break _v25$11;
													}
												}
							...
							if (maybeInput.$ === 'Just') {
								...
								return _Utils_Tuple2(
									...
									A2(
										...
										A2($elm$core$Basics$composeR, $author$project$Test$ApiSpecific, $author$project$Test$RunningSpecific),
										$elm$core$Task$succeed(
											$author$project$Api$handleInput(
												A2($miniBill$elm_codec$Codec$encodeToValue, $author$project$DTT$Data$InputForm$codec, input)))));
							} else {
								return _Utils_Tuple2(
									$author$project$Test$Running(
										_Utils_update(
											...
											{
												error: $elm$core$Maybe$Just(
													$author$project$Test$WrongInput(
				...
				if (_v0.b.$ === 'Waiting') {
					...
					switch (waitingMsg.$) {
						case 'GotSeed':
							var seed = waitingMsg.a;
							return $author$project$Test$validateWaitingModel(
								_Utils_update(
									waitingModel,
									{
										initialSeed: $elm$core$Maybe$Just(
											A2(
												$elm$random$Random$step,
						...
						case 'GotTime':
							var posix = waitingMsg.a;
							return $author$project$Test$validateWaitingModel(
								_Utils_update(
									waitingModel,
									{
										currentTime: $elm$core$Maybe$Just(
											$elm$time$Time$posixToMillis(posix))
									}));
						default:
							var string = waitingMsg.a;
							return $author$project$Test$validateWaitingModel(
								_Utils_update(
									waitingModel,
									{
										user: $elm$core$Maybe$Just(string)
									}));
					}
				} else {
					break _v0$2;
...
var $author$project$Test$ChangedAmount = function (a) {
	return {$: 'ChangedAmount', a: a};
};
var $author$project$Test$ChangedContent = function (a) {
	return {$: 'ChangedContent', a: a};
};
var $author$project$Test$ChangedId = function (a) {
	return {$: 'ChangedId', a: a};
};
var $author$project$Test$EnteredInput = function (a) {
	return {$: 'EnteredInput', a: a};
};
var $author$project$Test$GotUser = function (a) {
	return {$: 'GotUser', a: a};
};
...
var $Orasund$elm_ui_framework$Framework$Card$simple = _List_fromArray(
	[
...
var $author$project$Test$view = function (model) {
	var button = function (route) {
		...
		return A2(
			...
			{
				label: $mdgriffith$elm_ui$Element$text(action),
				onPress: $elm$core$Maybe$Just(
					$author$project$Test$EnteredInput(route))
			});
	};
	return A2(
		$Orasund$elm_ui_framework$Framework$layout,
		_List_Nil,
		A2(
			...
			function () {
				if (model.$ === 'Waiting') {
					return A2(
						$elm$core$List$map,
						$mdgriffith$elm_ui$Element$map($author$project$Test$WaitingSpecific),
						_List_fromArray(
							[
								A2(
								$mdgriffith$elm_ui$Element$el,
								$Orasund$elm_ui_framework$Framework$Heading$h1,
								$mdgriffith$elm_ui$Element$text('Select a User')),
								A2(
								...
								_List_fromArray(
									[
										...
										$Orasund$elm_ui_framework$Framework$Button$simple,
										{
											label: $mdgriffith$elm_ui$Element$text('Julia'),
											onPress: $elm$core$Maybe$Just(
												$author$project$Test$GotUser('Julia'))
										}),
										A2(
										$mdgriffith$elm_ui$Element$Input$button,
										$Orasund$elm_ui_framework$Framework$Button$simple,
										{
											label: $mdgriffith$elm_ui$Element$text('Lucas'),
											onPress: $elm$core$Maybe$Just(
												$author$project$Test$GotUser('Lucas'))
										})
									]))
							]));
				} else {
					var error = model.a.error;
					var todoList = model.a.todoList;
					var secretsList = model.a.secretsList;
					var budget = model.a.budget;
					var inputId = model.a.inputId;
					var inputContent = model.a.inputContent;
					var inputAmount = model.a.inputAmount;
					var apiModel = model.a.apiModel;
					return A2(
						$elm$core$List$map,
						$mdgriffith$elm_ui$Element$map($author$project$Test$RunningSpecific),
						_List_fromArray(
							[
								function () {
								if (error.$ === 'Just') {
									...
									return A2(
										$mdgriffith$elm_ui$Element$el,
										_Utils_ap($Orasund$elm_ui_framework$Framework$Card$large, $Orasund$elm_ui_framework$Framework$Color$danger),
										$mdgriffith$elm_ui$Element$text(
											function () {
												switch (e.$) {
													case 'InternalError':
														var errorType = e.a.errorType;
														var content = e.a.content;
														return 'Internal Error:' + (errorType + (' - ' + content));
													case 'ParsingError':
														var value = e.a;
													...
													default:
														var page = e.a.page;
														var action = e.a.action;
														return 'Wrong Input: ' + (page + (' - ' + action));
												}
											}()));
								} else {
								...
								$mdgriffith$elm_ui$Element$text('Logged in as ' + apiModel.user)),
								A2(
								$mdgriffith$elm_ui$Element$column,
								...
								_List_fromArray(
									[
										...
										$Orasund$elm_ui_framework$Framework$Input$simple,
										{
											...
											onChange: $author$project$Test$ChangedId,
										...
										$Orasund$elm_ui_framework$Framework$Input$simple,
										{
											...
											onChange: $author$project$Test$ChangedContent,
											placeholder: $elm$core$Maybe$Nothing,
											text: inputContent
										}),
										A2(
										...
										$Orasund$elm_ui_framework$Framework$Input$simple,
										{
											...
											onChange: $author$project$Test$ChangedAmount,
											placeholder: $elm$core$Maybe$Nothing,
											text: inputAmount
										}),
										A2(
										...
										$mdgriffith$elm_ui$Element$text('page:\"todo\"')),
										A2(
										...
										_List_fromArray(
											[
												button(
												{action: 'sync', page: 'todo'}),
												button(
												{action: 'insert', page: 'todo'}),
												button(
												{action: 'delete', page: 'todo'}),
												button(
												{action: 'update', page: 'todo'})
											])),
										A2(
										$mdgriffith$elm_ui$Element$el,
										$Orasund$elm_ui_framework$Framework$Heading$h3,
										$mdgriffith$elm_ui$Element$text('page:\"secrets\"')),
										A2(
										$mdgriffith$elm_ui$Element$paragraph,
										_List_Nil,
										_List_fromArray(
											[
												button(
												{action: 'sync', page: 'secrets'}),
												button(
												{action: 'insert', page: 'secrets'}),
												button(
												{action: 'delete', page: 'secrets'})
											])),
										A2(
										$mdgriffith$elm_ui$Element$el,
										$Orasund$elm_ui_framework$Framework$Heading$h3,
										$mdgriffith$elm_ui$Element$text('page:\"budget\"')),
										A2(
										$mdgriffith$elm_ui$Element$paragraph,
										_List_Nil,
										_List_fromArray(
											[
												button(
												{action: 'sync', page: 'budget'}),
												button(
												{action: 'insert', page: 'budget'}),
												button(
												{action: 'delete', page: 'budget'}),
												button(
												{action: 'update', page: 'budget'})
											]))
									])),
								A2(
								$mdgriffith$elm_ui$Element$el,
								$Orasund$elm_ui_framework$Framework$Heading$h2,
								$mdgriffith$elm_ui$Element$text('Todo List')),
								A2(
								$mdgriffith$elm_ui$Element$column,
								$Orasund$elm_ui_framework$Framework$Grid$section,
								A2(
									...
									function (_v3) {
										...
										var lastUpdated = _v3.lastUpdated;
										return A2(
											$mdgriffith$elm_ui$Element$row,
											...
											_List_fromArray(
												[
													$mdgriffith$elm_ui$Element$text(id),
													$mdgriffith$elm_ui$Element$text(user),
													$mdgriffith$elm_ui$Element$text(message),
													$mdgriffith$elm_ui$Element$text(
													'timestamp: ' + $elm$core$String$fromInt(
														$elm$time$Time$posixToMillis(lastUpdated)))
												]));
									},
									todoList)),
								A2(
								$mdgriffith$elm_ui$Element$el,
								$Orasund$elm_ui_framework$Framework$Heading$h2,
								$mdgriffith$elm_ui$Element$text('Secrets')),
								A2(
								$mdgriffith$elm_ui$Element$column,
								$Orasund$elm_ui_framework$Framework$Grid$section,
								A2(
										...
										return A2(
											...
											_List_fromArray(
												[
													$mdgriffith$elm_ui$Element$text(user),
													$mdgriffith$elm_ui$Element$text(
													A2($elm$core$String$left, 4, hash)),
													$mdgriffith$elm_ui$Element$text(
													A2($elm$core$Maybe$withDefault, '', raw))
												]));
									},
									secretsList)),
								A2(
								...
								$mdgriffith$elm_ui$Element$text(
								'Balance : ' + ($elm$core$String$fromFloat(budget.totalCent / 100) + '€')),
								A2(
								$mdgriffith$elm_ui$Element$column,
								$Orasund$elm_ui_framework$Framework$Grid$section,
								A2(
										...
										return A2(
											...
											_List_fromArray(
												[
													...
													$mdgriffith$elm_ui$Element$text(user),
													$mdgriffith$elm_ui$Element$text(
													$elm$core$String$fromFloat(cent / 100) + '€'),
