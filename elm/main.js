...
var $author$project$DTT$Data$InputForm$InputForm = F6(
	function (page, action, id, content, content2, amount) {
		return {action: action, amount: amount, content: content, content2: content2, id: id, page: page};
	});
					...
					switch (page) {
						...
						case 'todo':
							var _v6 = _Utils_Tuple2(
								...
								_Utils_Tuple3(
									id,
									_Utils_Tuple2(content, content2),
									amount));
							_v6$5:
							while (true) {
								if (_v6.b.a.$ === 'Just') {
									if (_v6.b.b.a.$ === 'Just') {
										if (((_v6.a === 'update') && (_v6.b.b.b.$ === 'Just')) && (_v6.b.c.$ === 'Nothing')) {
											var _v16 = _v6.b;
											var i = _v16.a.a;
											var _v17 = _v16.b;
											var message = _v17.a.a;
											var category = _v17.b.a;
											var _v18 = _v16.c;
											return $elm$core$Result$Ok(
												$author$project$Api$UpdateTodoEntry(
													{category: category, id: i, message: message}));
										} else {
											break _v6$5;
										}
									} else {
										if ((_v6.b.b.b.$ === 'Nothing') && (_v6.b.c.$ === 'Nothing')) {
											switch (_v6.a) {
												case 'delete':
													var _v11 = _v6.b;
													var i = _v11.a.a;
									...
									if (_v6.b.b.a.$ === 'Just') {
										if (((_v6.a === 'insert') && (_v6.b.b.b.$ === 'Just')) && (_v6.b.c.$ === 'Nothing')) {
											var _v7 = _v6.b;
											var _v8 = _v7.a;
											var _v9 = _v7.b;
											var message = _v9.a.a;
											var category = _v9.b.a;
											var _v10 = _v7.c;
											return $elm$core$Result$Ok(
												$author$project$Api$InsertTodoEntry(
													{category: category, message: message}));
										} else {
											break _v6$5;
										}
									} else {
										if (((_v6.a === 'sync') && (_v6.b.b.b.$ === 'Nothing')) && (_v6.b.c.$ === 'Nothing')) {
											var _v24 = _v6.b;
											var _v25 = _v24.a;
											var _v26 = _v24.b;
											var _v27 = _v26.a;
						...
						case 'budget':
							...
							while (true) {
								if (_v41.b.a.$ === 'Just') {
									if (_v41.b.b.$ === 'Nothing') {
										if ((_v41.a === 'delete') && (_v41.b.c.$ === 'Nothing')) {
											var _v44 = _v41.b;
											var i = _v44.a.a;
											var _v45 = _v44.b;
											var _v46 = _v44.c;
										...
										if ((_v41.a === 'update') && (_v41.b.c.$ === 'Just')) {
											var _v47 = _v41.b;
											var i = _v47.a.a;
											var reference = _v47.b.a;
											var cent = _v47.c.a;
											return $elm$core$Result$Ok(
									...
									if (_v41.b.b.$ === 'Just') {
										if ((_v41.a === 'insert') && (_v41.b.c.$ === 'Just')) {
											var _v42 = _v41.b;
											var _v43 = _v42.a;
											var reference = _v42.b.a;
											var cent = _v42.c.a;
											return $elm$core$Result$Ok(
										...
										if ((_v41.a === 'sync') && (_v41.b.c.$ === 'Nothing')) {
											var _v48 = _v41.b;
											var _v49 = _v48.a;
											var _v50 = _v48.b;
											var _v51 = _v48.c;
...
var $author$project$DTT$Data$TodoEntry$TodoEntry = F6(
	function (id, user, message, lastUpdated, checked, category) {
		return {category: category, checked: checked, id: id, lastUpdated: lastUpdated, message: message, user: user};
	});
				...
				return A2(
					...
					A2(
						...
						$author$project$DTT$Data$TodoEntry$insertResponse(
							{
								category: $elm$core$Maybe$Just(category),
							...
							$author$project$DTT$Data$TodoEntry$insertResponse(
								_Utils_update(
									entry,
									{
										...
										lastUpdated: config.currentTime,
										message: message
									}))) : $elm$core$Task$fail($author$project$DTT$Page$Todo$NoPermission);
					} else {
						return $elm$core$Task$succeed(_Utils_Tuple0);
					}
				},
				...
				if (result.$ === 'Ok') {
					...
					switch (input.$) {
						case 'InsertTodoEntry':
							...
							var category = input.a.category;
							var _v9 = A2(
								$elm$random$Random$step,
								A2(
									$author$project$DTT$Page$Todo$insertEntry,
									model,
									{category: category, message: message}),
								model.seed);
							var cmd = _v9.a;
